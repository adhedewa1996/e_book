...
class AppTheme {
  ...
  static final lightTheme = ThemeData(
    ...
    textTheme: TextTheme(
      // BOLD
      titleLarge: GoogleFonts.poppins(fontSize: 28.sp, fontWeight: FontWeight.bold, color: AppColors.textBlack),
      titleMedium: GoogleFonts.poppins(fontSize: 20.sp, fontWeight: FontWeight.bold, color: AppColors.textBlack),
      titleSmall: GoogleFonts.poppins(fontSize: 14.sp, fontWeight: FontWeight.bold, color: AppColors.textBlack),
      // SEMI BOLD
      bodyLarge: GoogleFonts.poppins(fontSize: 18.sp, fontWeight: FontWeight.w600, color: AppColors.textBlack),
      bodyMedium: GoogleFonts.poppins(fontSize: 16.sp, fontWeight: FontWeight.w600, color: AppColors.textBlack),
      // MEDIUM
