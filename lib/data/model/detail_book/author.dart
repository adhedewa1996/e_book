...
class Author {
  ...
  factory Author.fromMap(Map<String, dynamic> data) => Author(name: data['name'] as String?, birthYear: data['birth_year'] as int?, deathYear: data['death_year'] as int?);
  ...
  Author copyWith({String? name, int? birthYear, int? deathYear}) {
    return Author(name: name ?? this.name, birthYear: birthYear ?? this.birthYear, deathYear: deathYear ?? this.deathYear);
  }
}
